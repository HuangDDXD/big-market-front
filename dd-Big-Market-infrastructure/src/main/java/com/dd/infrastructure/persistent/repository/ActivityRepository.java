...
import com.dd.domain.activity.model.valobj.ActivityStateVO;
import com.dd.domain.activity.repository.IActivityRepository;
import com.dd.infrastructure.persistent.dao.IRaffleActivityCountDao;
import com.dd.infrastructure.persistent.dao.IRaffleActivityDao;
import com.dd.infrastructure.persistent.dao.IRaffleActivitySkuDao;
...
public class ActivityRepository implements IActivityRepository {
    ...
    @Override
    public ActivityCountEntity queryRaffleActivityCountByActvityCountId(Long activityCountId) {
        // 优先从缓存获取
